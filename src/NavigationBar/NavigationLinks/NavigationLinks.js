    ...
    return(
         <div className="col-6">
          <div className="row">
            ...
            <Dropdown>
             <Dropdown.Toggle id="register-dropdown">
              Register
             </Dropdown.Toggle>
              <Dropdown.Menu>
                <Dropdown.Item onClick={()=>this.setState({restaurantModal:true})}> Restaurant </Dropdown.Item>
                <RestaurantRegistrationModal
                  show={this.state.restaurantModal}
                  onHide={restaurantModalClose}
                  account = {this.state.account}
                />
                <Dropdown.Item onClick={()=>this.setState({riderModal:true})}>Rider</Dropdown.Item>
                <RiderRegistrationModal
                  show={this.state.riderModal}
                  onHide={riderModalClose}
                  account = {this.state.account}
                />
                <Dropdown.Item onClick={()=>this.setState({userModal:true})}>User</Dropdown.Item>
            ...
            <Dropdown>
              ...
              <Dropdown.Menu className="dropdown-menu-right">
                 ...
                 <Dropdown.Item  id="accountAddress">{this.state.account}</Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
